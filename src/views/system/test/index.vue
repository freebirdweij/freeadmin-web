  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column :show-overflow-tooltip="true" prop="dept" label="存放部门">
          <template slot-scope="scope">
...
const defaultForm = { propertyId: null, name: null, enabled: null, propertyType: null, dept: { id: null, name: null }, deptId: null, user: { id: null, name: null }, userId: null, createBy: null, updateBy: null, createTime: null, updateTime: null }
export default {
  name: 'AppProperty',
